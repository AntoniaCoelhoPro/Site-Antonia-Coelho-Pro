          ...
          <div className="text-center lg:text-left space-y-8">
            <div className="space-y-4">
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-gray-900 leading-tight">
                Atraia <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-green-600">Pacientes Qualificados</span> com Tráfego Pago Exclusivo para Médicos
              </h1>
              <p className="text-xl text-gray-600 max-w-2xl">
                <span className="font-semibold text-green-600">+50% de consultas em 3 meses</span> comprovados em nossos cases
              </p>
            </div>
            ...
            <div className="bg-white rounded-2xl p-6 shadow-lg max-w-md mx-auto lg:mx-0">
              <div className="flex items-center justify-between mb-4">
                <h3 className="text-lg font-semibold text-gray-900">Crescimento de Consultas</h3>
            ...
            <div className="grid grid-cols-3 gap-4 max-w-md mx-auto lg:mx-0">
              <div className="text-center">
                ...
                <p className="text-xs text-gray-600">Médicos Atendidos</p>
              </div>
              <div className="text-center">
            ...
            <div className="bg-white rounded-2xl shadow-2xl p-8 transform hover:scale-105 transition-all duration-300">
              <div className="text-center mb-6">
                ...
                <p className="text-gray-600">
                  Aumente sua agenda em 30 dias com nossa metodologia comprovada
                </p>
              </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                >
                  <span>Quero Aumentar Minha Agenda em 30 Dias</span>
