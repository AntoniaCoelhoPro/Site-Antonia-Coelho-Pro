    ...
    <section className="py-32">
      <div className="container flex flex-col gap-16 lg:px-16">
        <div className="lg:max-w-4xl mx-auto text-center">
          <h2 className="mb-3 section-title md:mb-4 lg:mb-6">
            {heading}
          </h2>
          <p className="mb-8 text-muted-foreground lg:text-lg text-center leading-relaxed">{description}</p>
          <a
            href={linkUrl}
          ...
          {features.map((feature) => (
            ...
            >
              ...
              <div className="px-6 py-8 md:px-8 md:py-10 lg:px-10 lg:py-12">
                <h3 className="mb-3 subsection-title md:mb-4 lg:mb-6">
                  {feature.title}
                </h3>
